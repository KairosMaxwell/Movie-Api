"""
Django settings for Building_Movie_API project.
...
SECRET_KEY = 'django-insecure-!%pui$8cbdgn!ad&tp6z-6+%8+gd&71idqk*@6qjirl64z#qv^'
...
ROOT_URLCONF = 'Building_Movie_API.urls'
...
WSGI_APPLICATION = 'Building_Movie_API.wsgi.application'
